CREATE PROCEDURE [featureFlags__featureFlagsConfig_Setup_usp].[test Specified Values Get Updated]
AS
BEGIN
	--ASSEMBLE
	...
	--ACT
	EXECUTE [featureFlags].[featureFlagsConfig_Setup_usp] @OptionalFeature1 = 0, @OptionalFeature2 = 1;
